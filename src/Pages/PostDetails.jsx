      ...
      <section className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8 transition-transform transform hover:scale-100 hover:shadow-2xl">
        <div className="post-detail-container">
          ...
          <p className="text-gray-700 leading-relaxed">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat
            amet impedit dolorem eos ut libero eum perferendis error a incidunt
            quidem aut porro vitae se
            d illo, nemo beatae quos possimus!
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Mollitia voluptates sequi, quas deserunt id eos quod voluptatibus quis ex, voluptatem magnam dolores alias explicabo officia quasi ullam culpa? Consequuntur, voluptate.
          </p>
        </div>
      </section>
    </>
